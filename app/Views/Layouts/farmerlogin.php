               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="index">
                              <h1 class="bg text-primary">Agriminds</h1>
                           </a>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        <ul class="navbar-nav mr-auto">
                           ...
                           <li class=" d_none get_btn">
                              <a href="viewmachine">Find a Machines</a>
                           </li>
   ...
   <section class="banner_main">
      <div class="container">
         <div class="row">
            <div class="col-md-12 ">
               <div class="text-bg">
                  <h1>Serving proud farmers!!!</h1>
                  <p>Agriminds Extension services provider gives talks, guidance and actual demonstration on latest
                     technologies related to agriculture</p>
                  <a href="#">Discover</a>
               </div>
            </div>
         </div>
   ...
   <div class="hottest">
      <div class="container">
         <div class="row d_flex">
            <div class="col-md-5">
               <div class="titlepage">
                  <h2>Something About <br>Agriminds</h2>
               </div>
            </div>
            <div class="col-md-7">
               <div class="hottest_box">
                  <p>Agriminds is the project developed in order to help farmer to get the required resources on time.
                     We provide different interfaces for farmer as well as service provider which will help farmer to
                     find the to reach out the services provided by the service provider.
                     Our project helps farmers to do modern farming which includes farming practices like large manpower
                     , Extensive use of equipments like threshers , harvesters and Tractors services.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="row d_flex">
                  ...
                  <div class="row">
                     <div class="col-md-6 padding_bottom">
                        <div class="choose_box">
                           ...
                           <div class="choose_text">
                              ...
                              <p>Best service is provided here!!!!!!!!!
                              </p>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6 padding_bottom">
                        <div class="choose_box">
                           ...
                           <div class="choose_text">
                              <h3>Clean Working</h3>
                              <p>Clean and clear working with best results and customer satisfaction!!!
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6">
                        <div class="choose_box">
                           ...
                           <div class="choose_text">
                              <h3>Expert Worker</h3>
                              <p>Workers are expert in their work and provides best work experience
                              </p>
                           </div>
                        </div>
                     </div>
            ...
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
               <div class="choose_img">
                  <figure><img src="images/food.jfif" alt="#" /></figure>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="about">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage">
                  <h2>People Says About Agriminds</h2>
               </div>
            </div>
         </div>
         <div class="row">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="test_box">
                                       ...
                                       <h4>Sushant</h4>
                                       <p>Agriminds is the platform where i got the solution of my farming related
                                          issues...</p>
                                    </div>
                                 </div>
                              </div>
      ...
      <div class="footer">
                     ...
                     <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                           <ul class="social_icon">
                              <li><a href="https://instagram.com/sushantsonawane_25?igshid=YmMyMTA2M2Y="><i
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>Copyright 2019 All Right Reserved By <a href="https://html.design/"> Akshay Malunjkar</a></p>
                  </div>
               </div>
            </div>
         </div>
